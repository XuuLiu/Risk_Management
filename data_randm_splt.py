...
#读取数据   
imp_datarote = r'D:\rm\0913\raw0925.txt'
...
#将iv中小于0.03的变量删除，此处index为8，9，10，11，17，18

str_index=[0,	1,	2,	3,	6,	7,	12,	13,	14,	15,	16,	19,	23,	24,	30]#保留的离散型变量
flt_index=[4,	5,	20,	21,	22,	25,	26,	27,	28,	29,	31]#保留的连续型变量



use_data_raw=np.zeros((4200,np.shape(smp_data)[1]-6))
...
#导出数据
ExportData(smp_data,'D:\\rm\\0926\\smp_data0926.txt')